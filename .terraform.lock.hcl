...
provider "registry.terraform.io/cloudposse/utils" {
  ...
  constraints = ">= 0.17.0"
  hashes = [
    "h1:7YfX5ES7nlgiTYd4s9bBovOPRmYizBU8rpLJWjDWqNc=",
...
provider "registry.terraform.io/hashicorp/aws" {
  version     = "4.22.0"
  constraints = ">= 2.0.0, >= 2.55.0, >= 3.0.0, >= 3.15.0, >= 3.72.0, >= 4.0.0, >= 4.12.0, >= 4.19.0, >= 4.22.0"
  hashes = [
...
provider "registry.terraform.io/hashicorp/kubernetes" {
  version     = "2.12.1"
  constraints = ">= 1.10.0, >= 2.10.0, >= 2.11.0, >= 2.12.1"
  hashes = [
